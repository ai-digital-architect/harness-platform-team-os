...
# py-events — Harness Platform repo context
...
1. `pk repo py-events` — confirm this repo's role and dependencies
...
3. `pk impact py-events` — before changing any interface another repo consumes
